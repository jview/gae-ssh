				...
				<div class="easyui-panel" title="EsbLink" style="width:400px;margin-right: 50px;">
				    ...
				    <form id="loginForm" method="post">
				    	<table>
							...
							<tr>
								<td>${app:i18n('password')}</td><td><input class="easyui-validatebox" type="password" id="password" name="password" value="sf123456" data-options="required:true" missingMessage="${app:i18n('msg.input.required')}"/></td>
							</tr>
							<tr>
								...
								<img title="Change on click" onclick="javascript:refresh(this);" src="../imageServlet">
								</td>
							</tr>
							<tr>
								<td colspan="2">
